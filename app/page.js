  ...
  return (
    ...
    <main className="flex flex-col  md:justify-between   overflow-y-scroll xs:gap-20 gap-10    " >
      ...
      <div 
         ...
         className=" gap-2 flex xs:gap-10 md:gap-20 md flex-col   relative h-screen  backdrop-blur-3xl text-slate-50">
        <div className="md:text-6xl xs:text-4xl text-2xl font-josefin font-bold  text-center space-y-6 shadow-xl ">
          <h1 className="mt-8 "  >Bienvenue au Cabinet Dentaire du Dr Oussama.</h1 >

          <p 
            
            className="xs:text-xl text-lg font-rubik">Nos soins, votre histoire</p>
         </div>
            ...
            <Buttondetails/>
            <a href="/rdv" className="rounded-xl border-2  py-2 px-3 font-semibold bg-accent text-black ">Rendez-vous</a>
        </div>
       <Video/>
